  ...
  useEffect(() => {
    const myFetch = async () => {
      try {
        ...
        url += `?api_key=12d319e4c11a90378b8b935ce9d0cbf9`;
        ...
        <div className="container text-white">
          <div className="row">
            <div className="col d-none d-md-flex align-items-center">
              ...
              <small>powered by thermoviedb.org</small>
            </div>
            <div className="col col-md-3 d-flex">
              <div className="me-3">
                <lable htmlFor="year" className="form-lable">
                  Year
                </lable>
              ...
              <div>
                <lable htmlFor="genre" className="form-lable">
                  Genre
                </lable>
